      ...
      <CardContent className="flex-1 flex flex-col justify-between">
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-600 min-h-[60px]">{concours.objectif}</p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">Présentation</h4>
            <p className="text-sm text-gray-600 min-h-[80px]">{concours.presentation}</p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">Livrables attendus</h4>
            <ul className="text-sm text-gray-600 list-disc list-inside text-left min-h-[80px]">
