    ...
    <section className="relative pt-32 pb-16 px-4">
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-4xl mx-auto leading-relaxed">
          Notre vision est d'aider l'élève à devenir un citoyen responsable en le mettant au cœur d'un dispositif pédagogique qui donne du sens aux apprentissages.
        </p>
